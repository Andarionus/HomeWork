...
Ход работы:
- После анализа шаблона таблицы и материалов связанных с самой игрой Save RTF (чуть позже был выложен билд на юнити, так что пришлось подкорректировать собраные данные из геймплея под актуальные цифры из скриптов) было выдвинуто следующее:
